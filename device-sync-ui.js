...
import { getAuth, GoogleAuthProvider, linkWithPopup, signInWithPopup } from "https://www.gstatic.com/firebasejs/9.22.1/firebase-auth.js";
...
class DeviceSyncUI {
  ...
  createAndAppendSyncButton() {
    ...
    // Füge Button direkt zum Hauptnavigation-Container hinzu
    const navigationContainer = document.getElementById('navigation-container');
    if (navigationContainer) {
      navigationContainer.appendChild(syncButton);
      console.log('✅ Sync-Button erfolgreich hinzugefügt');
    } else {
      console.warn('⚠️ navigation-container Container nicht gefunden');
    }
  }
  ...
  initializeModalEventListeners() {
    ...
    const googleAuthBtn = document.getElementById('googleAuthBtn'); // Korrigiert auf googleAuthBtn
    ...
    // E-Mail-Formular-Logik entfernt, da nicht Teil der aktuellen Anforderung.
  }
                ...
                if (linkError.code === 'auth/credential-already-in-use') {
                    ...
                    try {
                        ...
                        if (signInError.code === 'auth/popup-closed-by-user') {
                            return; // User hat Popup geschlossen - nichts tun
                        }
                        throw signInError; // Wirf andere Fehler weiter
                    }
                } else {
