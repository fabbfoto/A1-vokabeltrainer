...
// KORREKTUR: Der Typ 'DOMElements' wird importiert. Die Definition der
// Eigenschaften gehört in die Datei, in der DOMElements deklariert wird
// (vermutlich 'shared/types/ui.ts').
import type { DOMElements } from './shared/types/ui';

// Hilfsfunktion für sichere Element-Abfrage
