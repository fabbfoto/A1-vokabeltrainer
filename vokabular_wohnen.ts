...
export const vokabularWohnen: VocabularyStructure = createVocabulary({"Wohnen": {
        ...
        "Möbel und Einrichtung": [
            {id: createWordId("wohnen-zimmer-002"),
                ...
                english: "bed",
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-001"), text: "Ich", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-002"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-003"), text: "gehe", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-004"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-005"), text: "ins", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-006"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-007"), text: "Bett", case: "akkusativ" } as CaseElement,
            ...
            {id: createWordId("wohnen-schrank-001"),
                wordType: "noun",
                german: "Schrank",
                article: "der",
                plural: "Schränke",
                ...
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-009"), text: "Im", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-010"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-011"), text: "Schrank", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-012"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-013"), text: "sind", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-014"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-015"), text: "meine", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-016"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-017"), text: "Kleider", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-018"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "My clothes are in the closet.",
                clozeParts: ["Im ", " sind meine Kleider."],
                clozeAnswers: ["Schrank"]
            } as Noun,
            {id: createWordId("wohnen-regal-001"),
                wordType: "noun",
                german: "Regal",
                article: "das",
                plural: "Regale",
                english: "shelf / rack",
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-015"), text: "Die", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-016"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-017"), text: "Bücher", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-018"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-019"), text: "stehen", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-020"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-021"), text: "im", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-022"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-023"), text: "Regal", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-024"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "The books are on the shelf.",
                clozeParts: ["Die Bücher stehen im ", "."],
                clozeAnswers: ["Regal"]
            } as Noun,
            {id: createWordId("wohnen-tisch-001"),
                wordType: "noun",
                german: "Tisch",
                article: "der",
                plural: "Tische",
                english: "table",
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-021"), text: "Der", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-022"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-023"), text: "Tisch", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-024"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-025"), text: "steht", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-026"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-027"), text: "im", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-028"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-029"), text: "Wohnzimmer", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-030"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "The table is in the living room.",
                clozeParts: ["Der ", " steht im Wohnzimmer."],
                clozeAnswers: ["Tisch"]
            } as Noun,
            {id: createWordId("wohnen-stuhl-001"),
                wordType: "noun",
                german: "Stuhl",
                article: "der",
                plural: "Stühle",
                english: "chair",
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-027"), text: "Auf", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-028"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-029"), text: "dem", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-030"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-031"), text: "Stuhl", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-032"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-033"), text: "liegt", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-034"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-035"), text: "meine", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-036"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-037"), text: "Jacke", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-038"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "My jacket is on the chair.",
                clozeParts: ["Auf dem ", " liegt meine Jacke."],
                clozeAnswers: ["Stuhl"]
            } as Noun,
            {id: createWordId("wohnen-sessel-001"),
                wordType: "noun",
                german: "Sessel",
                article: "der",
                plural: "Sessel",
                english: "armchair",
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-033"), text: "Ich", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-034"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-035"), text: "sitze", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-036"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-037"), text: "gern", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-038"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-039"), text: "im", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-040"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-041"), text: "Sessel", case: "dativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-042"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "I like to sit in the armchair.",
                clozeParts: ["Ich sitze gern im ", "."],
                clozeAnswers: ["Sessel"]
            } as Noun,
            {id: createWordId("wohnen-sofa-001"),
                wordType: "noun",
                german: "Sofa",
                article: "das",
                plural: "Sofas",
                english: "sofa / couch",
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-041"), text: "Das", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-042"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-043"), text: "Sofa", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-044"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-045"), text: "ist", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-046"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-047"), text: "bequem", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-048"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "The sofa is comfortable.",
                clozeParts: ["Das ", " ist bequem."],
                clozeAnswers: ["Sofa"]
            } as Noun,
            {id: createWordId("wohnen-decke-001"),
                wordType: "noun",
                german: "Decke",
                article: "die",
                plural: "Decken",
                ...
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-047"), text: "Die", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-048"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-049"), text: "Decke", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-050"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-051"), text: "ist", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-052"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-053"), text: "warm", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-054"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "The blanket is warm.",
                clozeParts: ["Die ", " ist warm."],
                clozeAnswers: ["Decke"]
            } as Noun,
            {id: createWordId("wohnen-kissen-001"),
                wordType: "noun",
                german: "Kissen",
                article: "das",
                plural: "Kissen",
                ...
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-053"), text: "Ich", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-054"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-055"), text: "brauche", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-056"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-057"), text: "ein", case: "akkusativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-058"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-059"), text: "Kissen", case: "akkusativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-060"), text: ".", case: "none" } as CaseElement
                ],
                exampleEnglish: "I need a pillow.",
                clozeParts: ["Ich brauche ein ", "."],
                clozeAnswers: ["Kissen"]
            } as Noun,
            {id: createWordId("wohnen-teppich-001"),
                wordType: "noun",
                german: "Teppich",
                article: "der",
                plural: "Teppiche",
                english: "carpet / rug",
                exampleGerman: [
                    { id: createWordId("wohnen-m-bel-und-einrichtun-059"), text: "Der", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-060"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-061"), text: "Teppich", case: "nominativ" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-062"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-063"), text: "ist", case: "verb" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-064"), text: " ", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-065"), text: "bunt", case: "none" } as CaseElement,
                    { id: createWordId("wohnen-m-bel-und-einrichtun-066"), text: ".", case: "none" } as CaseElement
                ],
