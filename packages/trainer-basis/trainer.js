// packages/trainer-basis/trainer.js - FIREBASE-ERWEITERTE VERSION
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Ein zentrales State-Objekt, um den Zustand der App zu verwalten
    const state = {
        currentWortgruppeName: null,
    ...
    async function initWithFirebase() {
        console.log('🚀 Starte Basistrainer mit Firebase-Synchronisation...');
