...
export interface DOMElements {
  ...
  testProgressBarEl: HTMLElement;
  testProgressFillEl: HTMLElement;
  testProgressTextEl: HTMLElement;
  
  // Test Modal
  testModalEl: HTMLElement;
  testModalOverlayEl: HTMLElement;
  testModalCloseButtonEl: HTMLButtonElement;
  testModeButtonsContainerEl: HTMLElement;
  
  // Umlaut Support
  umlautButtonsContainerEl: HTMLElement;
  umlautButtonsContainer: HTMLElement; // Legacy naming
