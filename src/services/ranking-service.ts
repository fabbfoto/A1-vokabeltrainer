...
import { db } from '../infrastructure/auth/firebase-config';
import type { AuthService } from './auth-service';
import type { TrainerState, SessionStats, TestResult } from '../core/types/trainer';
import { calculateGlobalRankingScore } from '../core/types/trainer';
