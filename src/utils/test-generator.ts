// utils/test-generator.ts
import type { Word, TopicId, SubTopicId, ModeId, TestCategory } from '../core/types/trainer';
import type { VocabularyStructure } from '../core/types/vocabulary';
